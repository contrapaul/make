...
const TITLE_QUIPS = {
  ...
  TABLES: [
    ...
    ['TABLES, GLORIOUS',
     'HAST THOU EVER SEEN TABLES SUCH AS THESE?'],
    ['YOU\'LL FIND THAT IKEA IS A GOOD SOURCE OF',
     'IN ADDITION TO CHAIRS AND BEDDING'],
  ...
  COACH: [
    ['EVERY DECISION THIS',
     'MADE WAS TECHNICALLY WITHIN THE RULES'],
    ['NUFFLE KEEPS AN EYE ON THIS',
     'MOSTLY TO LAUGH AT THE ROSTER CHOICES'],
    ['THIS IS THE PUBLIC RECORD OF ONE',
     'WINS, LOSSES, AND EVERYTHING IN BETWEEN'],
    ['SOMEWHERE OUT THERE, THIS',
     'IS STILL BLAMING THE DICE'],
    ['SCOUT THIS',
     'BEFORE YOU AGREE TO A FRIENDLY MATCH'],
  ],

  'JOIN GAME': [
    ['SOMEONE SENT YOU A CODE. TIME TO',
     'AND FIND OUT WHAT YOU\'VE AGREED TO'],
    ['ENTER THE CODE AND',
     'BEFORE YOUR OPPONENT CHANGES THEIR MIND'],
    ['SIX CHARACTERS STAND BETWEEN YOU AND THIS',
     'NUFFLE DEMANDS PRECISION'],
    ['THIS IS WHERE YOU',
     'ASSUMING YOU TYPED THE CODE CORRECTLY'],
    ['CLICK HERE TO',
     'AND ACCEPT WHATEVER CHAOS AWAITS'],
  ],
