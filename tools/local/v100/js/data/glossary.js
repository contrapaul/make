/* ============================================================
   ...
   Rules (see style-guide.md, which governs this file):
     ...
     - Never define a term using another undefined term. If a
       definition needs one, list it in `see` so the reader can
       follow it, and keep the sentence readable without it.
...
export const GLOSSARY = [
  ...
  },
  {
    ...
    see: ['prefill', 'token', 'bandwidth', 'tokens-per-second'],
  },
  {
    id: 'gguf',
    term: 'GGUF',
    ...
    see: ['quantization', 'weights', 'offloading'],
  },
  {
    id: 'gpu',
    term: 'GPU',
  ...
  },
  {
    ...
    see: ['context-window', 'token', 'vram', 'decode'],
  },
  {
    id: 'latency',
    term: 'Latency',
    ...
    see: ['ttft', 'throughput', 'concurrency'],
  },
  {
    id: 'layer',
    term: 'Layer',
  ...
  },
  {
    ...
    see: ['cloud-ai', 'inference', 'open-weights', 'weights'],
  },
  {
    id: 'model',
    term: 'Model',
    ...
    see: ['weights', 'parameters', 'inference', 'layer'],
  },
  {
    id: 'offloading',
    term: 'Offloading',
    ...
    see: ['vram', 'ram', 'layer', 'bandwidth', 'cpu'],
  },
  {
    id: 'open-weights',
    term: 'Open weights',
  ...
  },
  {
    ...
    see: ['weights', 'quantization', 'model'],
  },
  {
    id: 'prefill',
    term: 'Prefill',
    ...
    see: ['decode', 'kv-cache', 'ttft', 'prompt'],
  },
  {
    id: 'prompt',
    term: 'Prompt',
    ...
    see: ['token', 'prefill', 'context-window'],
  },
  {
    id: 'quantization',
    term: 'Quantization',
    ...
    see: ['weights', 'parameters', 'gguf', 'vram'],
  },
  {
    id: 'ram',
    term: 'RAM',
    ...
    see: ['vram', 'offloading', 'bandwidth', 'cpu'],
  },
  {
    id: 'sampling',
    term: 'Sampling',
    ...
    see: ['temperature', 'top-p', 'token', 'vocabulary'],
  },
  {
    id: 'temperature',
    term: 'Temperature',
  ...
  },
  {
    ...
    see: ['concurrency', 'tokens-per-second', 'latency'],
  },
  {
    id: 'token',
    term: 'Token',
    ...
    see: ['tokenization', 'vocabulary', 'context-window'],
  },
  {
    id: 'tokenization',
    term: 'Tokenization',
  ...
  },
  {
    ...
    see: ['decode', 'bandwidth', 'throughput'],
  },
  {
    id: 'top-p',
    term: 'Top-p',
  ...
  },
  {
    ...
    see: ['gpu', 'ram', 'offloading', 'quantization', 'kv-cache'],
  },
  {
    id: 'weights',
    term: 'Weights',
    ...
    see: ['parameters', 'model', 'quantization', 'bandwidth'],
  },
];
